        ...
        <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
            ...
            <Box display="flex" sx={{ flexGrow: 1 }}>
                ...
                >
                    ...
                    <Stack spacing={1}>
                        <Button variant="text" size="small" fullWidth sx={{ justifyContent: 'flex-start' }}>Wallets</Button>
                        <Button variant="text" size="small" fullWidth sx={{ justifyContent: 'flex-start' }}>Goals</Button>
                        <Button variant="text" size="small" fullWidth sx={{ justifyContent: 'flex-start' }}>Chamas</Button>
                    </Stack>
                </Box>
